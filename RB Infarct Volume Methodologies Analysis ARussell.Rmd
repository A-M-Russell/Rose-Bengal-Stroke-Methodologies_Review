...
Can also use the pre-run workspace file to save time running the code: RB_Treatment_Efficacy_Workspace_ARussell_5.RData RENAME
Markdown file started on 28/11/2022, last updated xx/xx/2023 UPDATE
...
```{r Dataframe_summary_tables, include=FALSE, eval=FALSE}
...
summary(dfc3_summary_tables_rat$Surgical_level)
summary(dfc3_summary_tables_mouse$Surgical_level)

#summary tables by surgical level
table(dfc3_summary_tables_rat$Anaesthetic, dfc3_summary_tables_rat$Surgical_level) #rat
table(dfc3_summary_tables_mouse$Anaesthetic, dfc3_summary_tables_mouse$Surgical_level) #mouse
...
#summary for modal table - most common methods by rats and mice
...
Expected_brain_vol <- (mean(dfc3_Models_clean$Infarct_percent_control^Selected.lambda_clean))^(1/Selected.lambda_clean)
...
grid_Intensity<-expand.grid(Animal = "Rat",
     ...
     Light_aperture_cat = "0.02-1mm",
     Light_time_cat= "0.5-5mins", 
     Light_intensity_Wcm2 = seq(0.5, 10, by=0.2), # start at 0.5W/cm2 (min is 0.000249), go up to 10W/cm2 (max is 15.9, almost none that high) in 0.2W/cm2 increments
   weights = 8) #average n of animals = ~8
...
pdf("Continuous_predicted_intensity_3.pdf", width = 4.5, height = 4)
